...
class ResNet(nn.Module):
  def __init__(self, block, num_blocks, num_classes=10, activation=F.relu,
               output_features=False, normalize=False):
...
def ResNet18Feats():
  return ResNet(BasicBlock, [2, 2, 2, 2], output_features=True)


def ResNet18FeatsNorm():
  return ResNet(BasicBlock, [2, 2, 2, 2], output_features=True, normalize=True)


def ResNet18FeatsNormLeaky():
  return ResNet(BasicBlock, [2, 2, 2, 2], output_features=True, normalize=True, activation=F.leaky_relu)
